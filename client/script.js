...
const repeatMyParam = () => {
  ...
  return axios.get("http://localhost:3000/repeat/say-cheese").then((res) => {
...
const queryAttach = () => {
  ...
  axios
    .get("http://localhost:3000/query-test?myquery=How-to-code")
    .then((res) => {
...
/*
const queryAttach = () => {
axios.get('http://localhost:3000/repeat?myquery=Awesome&anotherQuery=cool')
